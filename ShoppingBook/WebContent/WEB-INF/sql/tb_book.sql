...
(
  ...
  create table tb_book                 
(
  bookId bigint primary key auto_increment,     //书号
 ...
 insert into tb_book values(null,1,1,'LINQ编程技术内幕','Microsoft核心技术丛书',59,51,'Image/linq.jpg',null,1,1,1,100);
 insert into tb_book values(null,1,1,'循序渐进DB2--DBA系统管理运维与应用案例','循序渐进DB2--DBA系统管理运维与应用案例',80,68.8,'Image/db2.jpg',null,0,1,1,100);
 insert into tb_book values(null,1,1,'ASP动态网页设计','基于Access数据库(计算机与信息技术专业应用教材)',35,30.1,'Image/asp.jpg',null,0,1,0,100);
 insert into tb_book values(null,1,2,'网络控制技术','网络控制技术',30,27,'Image/wlkzjs.jpg',null,1,0,1,100);
 insert into tb_book values(null,1,2,'网络配置与应用','全国信息技术人才培养工程指定培训教材',32,27.2,'Image/wlpzyyy.jpg',null,1,1,0,100);
 insert into tb_book values(null,1,2,'走近云计算','附光盘',49,41.6,'Image/zjyjs.jpg',null,1,1,1,100);
