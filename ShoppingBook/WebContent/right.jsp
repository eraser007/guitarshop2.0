...
<%@include file="common.jsp" %>
   	 <div class="right_content">
   	 			<div id="news">
   	 				<marquee direction="up" height="130px;" style="padding-top: 20px;" onmouseover="stop()" onmouseout="start()" >
   	 					<ul>
   	 						<li>打减价，大甩卖</li>
   	 						<li>疯狂十一，疯狂购买</li>
   	 						<li>买多送多，来看也送</li>
					...
					<fieldset>
						...
						<table>
							...
							<tr>
								...
								<td><input type="button" class="register" value="注册" id="toReg" onclick="" /></td>
							</tr>
							<tr>
